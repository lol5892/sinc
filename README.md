...
**Telegram Mini App** — совместное планирование недели (слева шкала 0–24, сверху дни; блоки дел перетаскиваются и тянутся по высоте) + бот с напоминаниями в чат. Стек: Vite + React, Express, SQLite (`data/planner.db`), Telegraf.
